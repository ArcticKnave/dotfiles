...
vim.pack.add({ "https://github.com/MunifTanjim/nui.nvim" }) -- necessary for noice to work
...
require("fzf-lua").setup({
	...
	fzf_opts = {
		['--layout'] = 'default', -- sets the inputfield at the bottom, and text is correct way
	},
	winopts = {
		fullscreen = true,
		preview = {
...
vim.keymap.set("n", "<leader>sf", require("fzf-lua").files, { desc = "Files" })
vim.keymap.set("n", "<leader>sr", require("fzf-lua").oldfiles, { desc = "Recent" })
vim.keymap.set("n", "<leader>sh", require("fzf-lua").help_tags, { desc = "Help" })
vim.keymap.set("n", "<leader>sg", require("fzf-lua").lgrep_curbuf, { desc = "Live Grep" })
vim.keymap.set("n", "<leader>so",
	[[<Cmd>lua require"fzf-lua".files({cwd="/mnt/Shared/Obsidian", file_ignore_patterns={ ".st", ".git", ".obsidian", ".ttx", "^.md" }})<CR>]],
	{ desc = "Obsidian" })
vim.keymap.set("n", "<leader>sd", [[<Cmd>lua require"fzf-lua".files({cwd="~/.config"})<CR>]], { desc = "Dotfiles" })
...
require("mini.move").setup() -- alt move lines
...
---------- Obisidan/Markdown Plugins --------
-- ZenMode, Obsidian.Nvim, Blink
...
require("blink.cmp").setup({
	...
	fuzzy = {
		implementation = "lua", -- cant get rust to work, probably an issue with nixos
...
require("zen-mode").setup({
	...
	-- THESE SETTINGS ARE TO FIX !q not closing buffer when in zenmode
...
require("obsidian").setup {
	workspaces = {
		{
			name = "Vault",
			path = "/mnt/Shared/Obsidian",
		},
	},
	legacy_commands = false,
	notes_subdir = "_Unsorted",
